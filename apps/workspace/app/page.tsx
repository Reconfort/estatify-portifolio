export default function Page() {
  return (
    <main className="mx-auto flex min-h-dvh max-w-3xl flex-col justify-center gap-4 px-6">
      <p className="text-overline uppercase text-muted-foreground">Estatify · workspace</p>
      <h1 className="text-display-md text-foreground">Workspace</h1>
      <p className="text-body-lg text-muted-foreground">Customer SaaS: properties, leads, agents, branding, analytics, billing.</p>
