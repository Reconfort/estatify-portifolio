    ...
    <section className="py-20 sm:py-28">
      <Container className="flex flex-col gap-14 sm:gap-16">
        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            {commitment.values.map((value, i) => (
              <li key={value.title}>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-body-sm leading-relaxed text-muted-foreground">{value.body}</p>
                </div>
                </Reveal>
              </li>
            ))}
          ...
          <div className="relative z-10 -mt-16 flex flex-col gap-4 self-end rounded-2xl bg-card p-6 shadow-lg ring-1 ring-border sm:mr-6 sm:max-w-md">
