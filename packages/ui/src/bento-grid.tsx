...
export function BentoCard({
  ...
  return (
    <div
      className={cn(
        "group relative flex flex-col overflow-hidden rounded-lg border border-border/80 bg-card p-6",
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col">
        {icon ? (
          <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-lg border border-primary/10 bg-primary/10 text-primary ring-1 ring-primary/5">
            {icon}
          </div>
        ) : null}
